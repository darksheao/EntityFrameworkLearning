...
namespace EntityFrameworkLearning.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ArtistID,Name,RowVersion")] Artist artist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ArtistID,Name,RowVersion")] Artist artist)
        {
            if (ModelState.IsValid)
            {
